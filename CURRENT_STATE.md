...
- Admin Portal main: `730cb18` (2026-09-14) — retains withdrawal optimistic concurrency and financial API/settings boundary work, and now consumes the backend dine-in lifecycle projection on the Dashboard (API + hook + lifecycle panel + contract test); exact-head validate passed at `730cb18`.
