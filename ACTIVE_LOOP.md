...
### Verified current GitHub state — 2026-09-15 UTC

- Backend main: `f3f72a652d2d361729214a48239a3cf08cf217ea` (2026-09-18) — §P.4 authoritative liability ledger PR #279 merged as squash. Final head `06d379cba8c2ee3c4e1f5c264550cba92d0c50d3`; exact-head CI workflow #1041 / run `35374960201` succeeded. P4 now covers the full major money-mutation writer set with caller-transaction-scoped double-entry postings, complete restricted-obligation families, provisional/verified/rejected custody clearing semantics, explicit fiat off-ramp clearing, evidence-backed PoR with a single effective denominator, and deterministic custody/liability reconciliation. Live production crypto signing/broadcast remains OFF; no production financial data was changed. Residual next-phase boundaries are inventory/cost-basis economics, route-aware conversion, Kotani Model A, GHS liquidity state/reconciliation, treasury movement controls, exchange integration/P&L and final PoR/treasury UI work as defined by the architecture.
...
4. Advance the next financial architecture slice: inventory/cost-basis economics (Model B), route-aware quote authority, GHS liquidity states/reconciliation, Kotani Model A, treasury controls, exchange abstraction and PoR/treasury read models.
