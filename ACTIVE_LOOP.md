...
5. Advance the next financial architecture slice: P5-B inventory/cost-basis economics, then route-aware quote authority, GHS liquidity states/reconciliation, Kotani Model A, treasury controls, exchange abstraction and PoR/treasury read models.
